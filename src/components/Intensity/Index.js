...
class Index extends Component
{
	...
	handleDelete(itemToDelete) {
        deleted = true;
        var referenceToDelete = firebase.database().ref('intensity').orderByChild('id').equalTo(itemToDelete.id);
        ...
        toastr.error('Intensity has been deleted successfully!', {position : 'top-right', heading: 'Done'});
	}
      ...
      return(
          	<div className="card mt-4">
			    <div className="card-header">
			        <h4 className="card-title"> Intensities </h4>
                    {userLoggedIn &&
                        <button type="button" className="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#addModal" onClick={this.handleDeleted()}> Add Intensity </button>
                    }
			    </div>
