...
class Index extends Component
{
	...
	handleDelete(itemToDelete) {
        deleted = true;
        var referenceToDelete = firebase.database().ref('language').orderByChild('id').equalTo(itemToDelete.id);
        ...
        toastr.error('Language has been deleted successfully!', {position : 'top-right', heading: 'Done'});
	}
      ...
      return(
          	<div className="card mt-4">
			    <div className="card-header">
                    ...
                    {userLoggedIn &&
                        <button type="button" className="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#addModal" onClick={this.handleDeleted()}> Add Language </button>
                    }
			    </div>
