      ...
      return(
          	<div className="card mt-4">
			    <div className="card-header">
                    ...
                    {userLoggedIn &&
                        <button type="button" className="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#addModal" onClick={this.handleDeleted()}> Add Course </button>
                    }
			    </div>
                        ...
                        <table className="table table-bordered">
                            ...
                            {this.state.originalData.map((data, i) => (
                                <tr key={i}>
                                    ...
                                    <td>
                                        {data.students.map((studentIndividual, i) => (
                                            <span>{(i+1)+'.'+studentIndividual.name+' '+studentIndividual.surname+' '}</span>
                                        ))}
                                    </td>
                                    <td>
